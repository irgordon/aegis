...
- Added first-run desktop usability evaluation for the public `v0.4.1` Developer Preview.

## [0.2.64] - 2026-07-04

### Changed

- Improved the gateway first-run help experience for the public Developer Preview.
- Added conventional `--help` and `-h` output that points to the bundled `health.check` smoke test.

## [0.2.63] - 2026-07-03

### Added

- Added a self-contained `health.check` gateway smoke-test fixture for generated Developer Preview artifacts.
- Updated artifact assembly workflows to stage the smoke-test fixture without packaging mutation examples.

### Changed

- Updated Developer Preview artifact guidance with a first-five-minutes gateway smoke-test command.
...
- Audited roadmap language to consistently reflect completed project phases and released milestones.
- Added phase completion language audit evidence.

## [0.2.60] - 2026-07-03

### Changed

- Updated project documentation to reflect the published `v0.4.1` Developer Preview.
- Replaced stale current-state wording that described public documentation as pre-download, source-only, or pre-alpha.

## [0.2.59] - 2026-07-03

### Changed

- Published the first public AEGIS `v0.4.1` Developer Preview.
- Recorded that the release remains prerelease, unsigned, not notarized, archive-only, and checksum-verified.
...
- Added a manual draft GitHub Release workflow for `v0.4.1` developer-preview artifacts.
- Added static workflow checks for draft-only release behavior and release boundary protections.

## [0.2.55] - 2026-07-02

### Added

- Added artifact-level review evidence for release binary path remapping.

## [0.2.54] - 2026-07-02

### Fixed

- Reduced embedded build/source path leakage in draft release binaries.
- Kept the desktop source-tree policy fallback out of release builds while preserving it for debug development builds.

### Changed

- Updated draft artifact workflow checks to enforce release path remapping before binary builds.

## [0.2.53] - 2026-07-02

### Changed

- Audited Phase 5 planning documents for roadmap accuracy and current project status.
- Separated active Developer Distribution work from completed inputs and deferred future phases.
...
- Added artifact-level verification evidence for the combined v0.4.1 draft artifact checksum manifest.
