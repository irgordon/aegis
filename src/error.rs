...
pub enum ErrorCode {
    ...
    StateInspectionReadFailed,
    StateInspectionInvalidJsonRecord,
    StateInspectionUnknownLifecycleState,
    StateInspectionInvalidTransition,
